/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 83a5d2374c9f2cf072f73af3622fca1e)
// Runtime types generated with workerd@1.20260811.1 2025-03-01 nodejs_compat
interface __BaseEnv_Env {
	AI_QUEUE: Queue;
	SECRET: SecretsStoreSecret;
	COP_DB_BASE: string;
	BOARD_HUB: DurableObjectNamespace<import("./src/index").BoardHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BoardHub";
	}
